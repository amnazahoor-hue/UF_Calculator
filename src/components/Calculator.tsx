...
const CalculatorSharePanel = dynamic(
  () => import("./CalculatorSharePanel").then((m) => ({ default: m.CalculatorSharePanel })),
  { ssr: false },
);
...
export function Calculator({ variant = "section" }: CalculatorProps) {
  ...
  const card = (
    ...
    >
            ...
            {hasResult && sharePayload ? <CalculatorSharePanel payload={sharePayload} /> : null}
